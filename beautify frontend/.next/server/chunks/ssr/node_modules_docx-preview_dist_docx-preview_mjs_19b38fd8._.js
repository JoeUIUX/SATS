...
"[project]/node_modules/docx-preview/dist/docx-preview.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class OpenXmlPackage {
    ...
    static async load(input, options) {
        const zip = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jszip$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].loadAsync(input);
...
class HtmlRenderer {
    ...
    async render(document1, bodyContainer, styleContainer = null, options) {
        ...
        if (document1.themePart) {
            ...
            this.renderTheme(document1.themePart, styleContainer);
        }
        if (document1.stylesPart != null) {
            ...
            styleContainer.appendChild(this.renderStyles(document1.stylesPart.styles));
        }
        if (document1.numberingPart) {
            ...
            styleContainer.appendChild(this.renderNumbering(document1.numberingPart.domNumberings, styleContainer));
        }
        ...
        if (!options.ignoreFonts && document1.fontTablePart) this.renderFontTable(document1.fontTablePart, styleContainer);
    ...
    renderSections(document1) {
        ...
        for(let i = 0, l = pages.length; i < l; i++){
            ...
            this.renderStyleValues(document1.cssStyle, pageElement);
...
`;
    ...
    renderMmlRadical(elem) {
        ...
        if (elem.props?.hideDegree) {
            return this.createElementNS(ns.mathML, "msqrt", null, this.renderElements([
                base
            ]));
        }
        const degree = elem.children.find((el)=>el.type == DomType.MmlDegree);
        return this.createElementNS(ns.mathML, "mroot", null, this.renderElements([
            base,
            degree
        ]));
    }
    renderMmlDelimiter(elem) {
        const children = [];
        children.push(this.createElementNS(ns.mathML, "mo", null, [
    ...
    renderMmlNary(elem) {
        ...
        if (supElem || subElem) {
            children.push(this.createElementNS(ns.mathML, "munderover", null, [
                charElem,
                subElem,
                supElem
            ]));
        } else if (supElem) {
            children.push(this.createElementNS(ns.mathML, "mover", null, [
                charElem,
                supElem
            ]));
        } else if (subElem) {
            children.push(this.createElementNS(ns.mathML, "munder", null, [
                charElem,
                subElem
            ]));
        } else {
    ...
    renderMmlGroupChar(elem) {
        ...
        if (elem.props.char) {
            result.appendChild(this.createElementNS(ns.mathML, "mo", null, [
                elem.props.char
            ]));
        }
        return result;
    ...
    renderMllList(elem) {
        ...
        for (let child of this.renderElements(elem.children)){
            result.appendChild(this.createElementNS(ns.mathML, "mtr", null, [
                this.createElementNS(ns.mathML, "mtd", null, [
                    child
                ])
            ]));
        }
...
async function renderDocument(document1, bodyContainer, styleContainer, userOptions) {
    const ops = {
        ...defaultOptions,
        ...userOptions
    };
    const renderer = new HtmlRenderer(window.document);
    return await renderer.render(document1, bodyContainer, styleContainer, ops);
}
...
//# sourceMappingURL=node_modules_docx-preview_dist_docx-preview_mjs_19b38fd8._.js.map