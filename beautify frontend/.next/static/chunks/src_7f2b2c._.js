(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_7f2b2c._.js", {
...
const ToTestList = ({ zIndex, onMouseDown, onClose, bringWindowToFront, windowZIndexes, zIndexCounter })=>{
    ...
    // The key change is ensuring the zIndex is applied directly and forcefully
    // with no additional container elements to interfere
...
const ThreeDModelWindow = ({ profileId, zIndex, onMouseDown, onClose, bringWindowToFront, windowZIndexes, zIndexCounter, showThreeDModelWindow })=>{
    ...
    const [canvasBgColor, setCanvasBgColor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("#ffffff"); // For Canvas background
    ...
    const [portalElement] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ThreeDModelWindow.useState": ()=>{
            const element = document.createElement("div");
            element.id = "threeDModelWindow-root";
            document.body.appendChild(element);
            return element;
        }
    }["ThreeDModelWindow.useState"]);
        ...
        "ThreeDModelWindow.useEffect": ()=>{
            ...
            const fetchModelData = {
                "ThreeDModelWindow.useEffect.fetchModelData": async ()=>{
                    ...
                    setModelError(null);
                    try {
                        console.log(`🌐 Fetching model for profile ID: ${profileId}`);
        ...
        "ThreeDModelWindow.useEffect": ()=>{
            ...
            const observer = new MutationObserver({
                "ThreeDModelWindow.useEffect": (mutations)=>{
                    mutations.forEach({
                        "ThreeDModelWindow.useEffect": (mutation)=>{
                            if (mutation.attributeName === "class") {
                                checkDarkMode();
                            }
                        }
    ...
    const handleFileUpload = async ()=>{
        ...
        try {
            ...
            setModelError(null);
            // Add a small delay before hiding the success message
            setTimeout(()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeDModelWindow.useEffect": ()=>{
            console.log(`ThreeDModelWindow mounted, showThreeDModelWindow: ${showThreeDModelWindow}, profileId: ${profileId}`);
            return ({
                "ThreeDModelWindow.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeDModelWindow.useEffect": ()=>{
            console.log(`🎯 ThreeDModelWindow using z-index:`, effectiveZIndex);
        }
    }["ThreeDModelWindow.useEffect"], [
        effectiveZIndex
    ]);
    if (!showThreeDModelWindow) {
        console.log("ThreeDModelWindow should not be visible, returning null");
        return null;
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$draggable$2f$build$2f$cjs$2f$cjs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        nodeRef: nodeRef,
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        modelLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            style: {
                                padding: "20px"
                            },
                            ...
                            lineNumber: 312,
                            columnNumber: 13
                        }, this) : modelError || errorMessage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s1(ThreeDModelWindow, "LOhsOWn/enB9oInGaamA43EwC68=");
...
const ServerWindow = ({ zIndex, onMouseDown, onClose, bringWindowToFront, windowZIndexes, zIndexCounter })=>{
    ...
    console.log(`🎯 ServerWindow using z-index:`, effectiveZIndex);
...
function Page() {
    ...
    const openModelWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[openModelWindow]": (profileId = 1)=>{
            ...
            // Debug logging with setTimeout to verify state updates
            setTimeout({
                "Page.useCallback[openModelWindow]": ()=>{
                    console.log(`State after openModelWindow: showThreeDModelWindow=${showThreeDModelWindow}, profileId=${threeDModelProfileId}`);
                }
    ...
    // Added debug logging for window state changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Page.useEffect": ()=>{
...
_s(Page, "NQTQ5k03WfhH8HAVBVrdFRsifaA=");
_c = Page;
var _c;
...
//# sourceMappingURL=src_7f2b2c._.js.map