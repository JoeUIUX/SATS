(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_cbf54a._.js", {
...
const ToTestList = ({ zIndex, onMouseDown, onClose, bringWindowToFront, windowZIndexes, zIndexCounter })=>{
    _s();
    const nodeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // ✅ Ensure nodeRef is initialized
    ...
    const [currentZIndex, setCurrentZIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(zIndex); // ✅ Track `zIndex`
    // Portal management
...
_s(ToTestList, "EjlfcSh8QFrP+eqyAXnvsp61bCQ=");
_c = ToTestList;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$rnd$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-rnd/lib/index.js [app-client] (ecmascript)"); // ✅ Use `react-rnd` instead of `react-draggable`
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react-dom/index.js [app-client] (ecmascript)");
...
_s(ServerWindow, "MCAQTGdv/GzLNx6+Oktj9F+YHxs=", false, function() {
    return [
...
_s(WelcomeWindow, "UbfzG6oca8CSpnSZrz7dTop3ycQ=");
_c = WelcomeWindow;
...
_s(MainScreen, "PnzrrxDEvp/Sdmfw1CL8sSDqWs4=", false, function() {
    return [
...
;
;
const API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.REACT_APP_BACKEND_URL || "http://127.0.0.1:5000"; // Backend URL
// Create a fallback mesh component for when model loading fails
const FallbackModel = ()=>{
...
const SatelliteModel = ({ modelPath, scale = 40, position = [
    ...
    // Use safer error handling with the GLTFLoader
    let gltf;
    try {
        gltf = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$2895749c$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__F__as__useLoader$3e$__["useLoader"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$loaders$2f$GLTFLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GLTFLoader"], modelPath, undefined, {
            "SatelliteModel.useLoader": (error)=>{
                console.error("Error loading model:", error);
                setError(true);
            }
        }["SatelliteModel.useLoader"]);
        // If we get here without error, the model has loaded
        if (!loaded && gltf) {
            setLoaded(true);
            // Extract dominant color if needed
            if (onColorExtracted && gltf.scene) {
                const firstMesh = gltf.scene.children.find((child)=>child instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Mesh);
                if (firstMesh && firstMesh.material instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.MeshStandardMaterial) {
                    onColorExtracted(firstMesh.material.color);
                }
            }
        }
    } catch (e) {
        ...
        setError(true);
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FallbackModel, {}, void 0, false, {
            fileName: "[project]/src/components/ModelWindow/ThreeDModelWindow.tsx",
            lineNumber: 68,
            columnNumber: 12
        }, this);
...
_s(SatelliteModel, "zZaFTYSxm9Krp8c1itiyT3KjbFA=", false, function() {
    return [
...
_c1 = SatelliteModel;
const ThreeDModelWindow = ({ profileId, zIndex, onMouseDown, onClose, bringWindowToFront })=>{
    _s1();
    const [isDarkMode, setIsDarkMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Fix: Define nodeRef with correct typing for Draggable
    const nodeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [selectedFile, setSelectedFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [canvasBgColor, setCanvasBgColor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("#f0f0f0");
    const [portalRoot, setPortalRoot] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Create portal root if needed
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeDModelWindow.useEffect": ()=>{
            let root = document.getElementById("model-window-portal");
            if (!root) {
                root = document.createElement("div");
                root.id = "model-window-portal";
                document.body.appendChild(root);
            }
            setPortalRoot(root);
            return ({
                "ThreeDModelWindow.useEffect": ()=>{
                    // Clean up only if we created it and no other instances need it
                    if (root && root.id === "model-window-portal" && document.querySelectorAll('[data-model-window="true"]').length <= 1) {
    ...
    // Bring window to front when mounted
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeDModelWindow.useEffect": ()=>{
            // Ensure the window is brought to front
            console.log("ThreeDModelWindow mounted, bringing to front");
            setTimeout({
                "ThreeDModelWindow.useEffect": ()=>{
                    bringWindowToFront("ThreeDModelWindow");
                }
            }["ThreeDModelWindow.useEffect"], 100);
        }
    }["ThreeDModelWindow.useEffect"], [
        bringWindowToFront
    ]);
    // Fetch model path from backend or use test model
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThreeDModelWindow.useEffect": ()=>{
            const fetchModelPath = {
                "ThreeDModelWindow.useEffect.fetchModelPath": async ()=>{
                    try {
                        ...
                        if (data.model_path) {
                            ...
                            const fullModelPath = data.model_path.startsWith("http") ? data.model_path : `${API_URL}${data.model_path}`;
                            setModelPath(fullModelPath);
                            setErrorMessage(null);
                        } else {
                            // Model path not found, use default test model
                            setModelPath("/models/default_satellite.glb");
                            setErrorMessage("No model file available. Upload a .glb file below.");
                        }
                    } catch (error) {
                        console.error("Error fetching model path:", error);
                        setModelPath("/models/default_satellite.glb");
                        setErrorMessage("Failed to load model information. Using test model.");
                    }
                }
            }["ThreeDModelWindow.useEffect.fetchModelPath"];
            fetchModelPath();
        }
    }["ThreeDModelWindow.useEffect"], [
        profileId
    ...
    const handleFileUpload = async ()=>{
        ...
        try {
            ...
            const data = await response.json();
            if (data.model_path) {
                const fullPath = `${API_URL}${data.model_path}`;
            ...
            setErrorMessage("Failed to upload model. Please try again.");
        }
    };
    // For testing when model loading fails
    const handleFileSelect = (event)=>{
        if (event.target.files && event.target.files.length > 0) {
            setSelectedFile(event.target.files[0]);
        }
    };
    // If portal root isn't ready yet, don't render anything
    if (!portalRoot) {
        return null;
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$draggable$2f$build$2f$cjs$2f$cjs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            ...
                            children: "Satellite 3D Model Viewer"
                        }, void 0, false, {
                            fileName: "[project]/src/components/ModelWindow/ThreeDModelWindow.tsx",
                            lineNumber: 279,
                            columnNumber: 11
                    ...
                    children: [
                        errorMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            style: {
                                padding: "10px",
                                marginBottom: "15px",
                                backgroundColor: isDarkMode ? "#3a2500" : "#fff3cd",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
                                ...
                                children: modelPath ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$react$2d$three$2d$fiber$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Canvas"], {
                                    camera: {
                                        position: [
                                            0,
                                            0,
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            style: {
                                                marginLeft: "10px",
                                                padding: "8px 16px",
                                                backgroundColor: selectedFile ? "#00bcd4" : "#ccc",
                                                color: "white",
                                                border: "none",
                                                borderRadius: "4px",
...
_s1(ThreeDModelWindow, "MFnffWf2cQp+u3nMuJ9+cmBIxNE=");
_c2 = ThreeDModelWindow;
const __TURBOPACK__default__export__ = ThreeDModelWindow;
var _c, _c1, _c2;
__turbopack_refresh__.register(_c, "FallbackModel");
__turbopack_refresh__.register(_c1, "SatelliteModel");
__turbopack_refresh__.register(_c2, "ThreeDModelWindow");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function Page() {
    ...
    const [showToTestList, setShowToTestList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showServerWindow, setShowServerWindow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showThreeDModelWindow, setShowThreeDModelWindow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [threeDModelProfileId, setThreeDModelProfileId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1); // Default value for testing
    const [showWelcomeWindow, setShowWelcomeWindow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const bringWindowToFront = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[bringWindowToFront]": (windowName)=>{
            ...
            // Calculate highest z-index + 1
            const highestZIndex = Math.max(...Object.values(windowZIndexes));
            ...
            setWindowZIndexes({
                "Page.useCallback[bringWindowToFront]": (prevIndexes)=>{
                    ...
                    console.log(`New z-index values:`, newIndexes);
                    return newIndexes;
                }
            }["Page.useCallback[bringWindowToFront]"]);
            // Update counter for future windows
    ...
    const openModelWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[openModelWindow]": (profileId = 1)=>{
            console.log("Opening 3D Model window for profile:", profileId);
            // Set the profile ID
            setThreeDModelProfileId(profileId);
            // Make sure window state is set to visible
            setShowThreeDModelWindow(true);
            // Use a setTimeout to ensure the state updates before changing z-index
            setTimeout({
                "Page.useCallback[openModelWindow]": ()=>{
                    console.log("Now bringing 3D Model window to front");
                    bringWindowToFront("ThreeDModelWindow");
                }
            }["Page.useCallback[openModelWindow]"], 100);
        }
    }["Page.useCallback[openModelWindow]"], [
        bringWindowToFront
    ]);
    const closeModelWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[closeModelWindow]": ()=>{
            console.log("Closing 3D Model window");
    ...
    const DebugControl = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            style: {
                position: 'fixed',
                bottom: 50,
                right: 10,
...
_s(Page, "y3vVT0Fi9+cki0E0CuFuCMCXTYw=");
_c = Page;
var _c;
...
//# sourceMappingURL=src_cbf54a._.js.map