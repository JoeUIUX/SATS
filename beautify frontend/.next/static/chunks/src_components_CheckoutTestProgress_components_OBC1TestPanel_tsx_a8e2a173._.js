...
const OBC1TestPanel = ({ options, sock, onTestComplete, onTestError, onTestStart, isInitialRun })=>{
    ...
    // callback function:
    const handleTestComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OBC1TestPanel.useCallback[handleTestComplete]": (testResults)=>{
            ...
            setTimeout({
                "OBC1TestPanel.useCallback[handleTestComplete]": ()=>{
                    onTestComplete(testResults);
                }
            }["OBC1TestPanel.useCallback[handleTestComplete]"], 100);
        }
    }["OBC1TestPanel.useCallback[handleTestComplete]"], [
        onTestComplete
    ]);
...
_s(OBC1TestPanel, "NsrBiaJwohq1HL97Sw0E4eRPFCs=");
_c1 = OBC1TestPanel;
var _c, _c1;
