        ...
        if (file.type === "text/plain") {
            ...
            reader.onload = async (e)=>{
                if (e.target?.result instanceof ArrayBuffer) {
                    try {
                        const textResult = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mammoth$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].convertToHtml({
...
_s(MainScreen, "o0Ga1sKk1G4Sp9s+wv15pjiU47s=", false, function() {
    return [
