(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_467b70a7._.js", {
...
function Page() {
    ...
    const openSettingsWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[openSettingsWindow]": ()=>{
            ...
            // Set visibility directly
            setWindowVisibility({
                "Page.useCallback[openSettingsWindow]": (prev)=>({
                        ...prev,
                        SettingsWindow: true
                    })
            }["Page.useCallback[openSettingsWindow]"]);
            // Update z-index
            setWindowZIndexes({
                "Page.useCallback[openSettingsWindow]": (prevIndexes)=>{
                    const highestZIndex = Math.max(...Object.values(prevIndexes), 10000);
                    return {
                        ...prevIndexes,
            ...
            setZIndexCounter({
                "Page.useCallback[openSettingsWindow]": (prev)=>prev + 1
            }["Page.useCallback[openSettingsWindow]"]);
        }
    }["Page.useCallback[openSettingsWindow]"], []);
    const closeSettingsWindow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[closeSettingsWindow]": ()=>{
            ...
            setWindowVisibility({
                "Page.useCallback[closeSettingsWindow]": (prev)=>({
                        ...prev,
                        SettingsWindow: false
                    })
            }["Page.useCallback[closeSettingsWindow]"]);
...
//# sourceMappingURL=src_467b70a7._.js.map