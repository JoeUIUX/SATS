(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_components_MainScreen_97ecd62c._.js", {
...
const MainScreen = ({ openToTestList, closeToTestList, openServerWindow, openModelWindow, closeModelWindow, showToTestList, showThreeDModelWindow, threeDModelProfileId, windowZIndexes, bringWindowToFront, zIndexCounter, showSettingsWindow, openSettingsWindow, closeSettingsWindow })=>{
    ...
    const [dummyState, setDummyState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // state for forcing re-renders
    ...
    const [settingsWindowVisible, setSettingsWindowVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(showSettingsWindow);
        ...
        "MainScreen.useEffect": ()=>{
            if (selectedProfile) {
                ...
                const timer = setTimeout({
                    "MainScreen.useEffect.timer": ()=>{
                        handleLoadCheckout(selectedProfile);
                    }
                }["MainScreen.useEffect.timer"], 50);
                return ({
                    "MainScreen.useEffect": ()=>clearTimeout(timer)
                })["MainScreen.useEffect"];
            }
        }
    }["MainScreen.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MainScreen.useEffect": ()=>{
            ...
            const droppedIds = droppedItems.map({
                "MainScreen.useEffect.droppedIds": (item)=>item.id
            }["MainScreen.useEffect.droppedIds"]);
            // Check if there are items that should be in droppedItems but aren't
            const itemsThatShouldBeDropped = items.filter({
                "MainScreen.useEffect.itemsThatShouldBeDropped": (item)=>item.isDropped && !droppedIds.includes(item.id)
            }["MainScreen.useEffect.itemsThatShouldBeDropped"]);
...
_s(MainScreen, "fVF+wVvKgoX8o7Ty2hFgi2sD7bE=", false, function() {
    return [
...
//# sourceMappingURL=src_components_MainScreen_97ecd62c._.js.map