(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_components_4c5615b0._.js", {
...
const ServerWindow = ({ zIndex, onMouseDown, onClose, onMinimize, bringWindowToFront, windowZIndexes, zIndexCounter })=>{
    ...
    const navigate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$BAXFHI7N$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigate"])();
    ...
    const testProxyConnection = async ()=>{
        try {
            ...
            const isConnected = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["testWebSocketConnection"])(`localhost:8080`);
            if (isConnected) {
...
"[project]/src/components/FontLoader/FontLoader.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const FontLoader = ({ fontFamily = 'System Default' })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FontLoader.useEffect": ()=>{
            ...
            const loadFonts = {
                "FontLoader.useEffect.loadFonts": async ()=>{
                    ...
                    if (!loadedFonts.includes(baseFontName)) {
                        ...
                        setLoadedFonts({
                            "FontLoader.useEffect.loadFonts": (prev)=>[
                                    ...prev,
                                    baseFontName
                                ]
                        }["FontLoader.useEffect.loadFonts"]);
      ...
      `;
            ...
            const forceUpdateTimer = setTimeout({
                "FontLoader.useEffect.forceUpdateTimer": ()=>{
                    // This empty function will trigger a re-render due to the useEffect dependency
                    setLoadedFonts({
                        "FontLoader.useEffect.forceUpdateTimer": (prev)=>[
                                ...prev
                            ]
                    }["FontLoader.useEffect.forceUpdateTimer"]);
                }
            }["FontLoader.useEffect.forceUpdateTimer"], 100);
            return ({
                "FontLoader.useEffect": ()=>clearTimeout(forceUpdateTimer)
            })["FontLoader.useEffect"];
        }
    }["FontLoader.useEffect"], [
        fontFamily,
...
_s(FontLoader, "aq0BLQD4Bewrv6iIpLFlno/ONKM=");
_c = FontLoader;
...
//# sourceMappingURL=src_components_4c5615b0._.js.map