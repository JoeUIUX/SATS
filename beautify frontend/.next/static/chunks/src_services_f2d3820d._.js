(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_services_f2d3820d._.js", {
 ...
 */ async function generateOBC1WordReport(results) {
        ...
        sections: [
            {
                ...
                children: [
                    ...
                    ...results.fpga ? createFpgaInfoParagraphs(results) : [
                        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"]({
                    ...
                    ...results.vi && results.temperatures ? createViInfoParagraphs(results) : [
                        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"]({
                    ...
                    ...results.emmc ? createEmmcInfoParagraphs(results) : [
                        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"]({
 ...
 */ async function generateOBC1PDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
    ...
    try {
        ...
        if (results.temperatures) {
            ...
            if (tempData.leocam && Array.isArray(tempData.leocam)) {
                tempData.leocam.forEach((temp, index)=>{
...
function createKernelInfoTable(results) {
    ...
    const rows = [
        [
            'Uptime',
            `${kernelData.uptime || 'N/A'} s`
        ],
        [
            '1 minute average loads',
            kernelData.loads?.oneMinute || 'N/A'
        ],
        [
            '5 minutes average loads',
            kernelData.loads?.fiveMinute || 'N/A'
        ],
        [
            '15 minutes average loads',
            kernelData.loads?.fifteenMinute || 'N/A'
        ],
        [
            'Total usable main memory size',
            `${kernelData.memory?.totalRam || 'N/A'} bytes`
        ],
        [
            'Available memory size',
            `${kernelData.memory?.freeRam || 'N/A'} bytes`
        ],
        [
            'Amount of shared memory',
            `${kernelData.memory?.sharedRam || 'N/A'} bytes`
        ],
        [
            'Memory used by buffers',
            `${kernelData.memory?.bufferRam || 'N/A'} bytes`
        ],
        [
            'Total swap space size',
            `${kernelData.memory?.totalSwap || 'N/A'} bytes`
        ],
        [
            'Swap space still available',
            `${kernelData.memory?.freeSwap || 'N/A'} bytes`
        ],
        [
            'Number of current processes',
            `${kernelData.processes || 'N/A'}`
        ],
        [
            'Total high memory size',
            `${kernelData.memory?.totalHigh || 'N/A'} bytes`
        ],
        [
            'Available high memory size',
            `${kernelData.memory?.freeHigh || 'N/A'} bytes`
        ],
        [
            'Memory unit size in bytes',
            `${kernelData.memory?.memUnit || 'N/A'} bytes`
        ]
...
function createFpgaInfoParagraphs(results) {
    ...
    return [
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`vcc_pspll       : ${padString(voltages.vccPspll || 'N/A', 4)} V`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`vcc_psbatt      : ${padString(voltages.vccPsbatt || 'N/A', 4)} V`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`vccint          : ${padString(voltages.vccint || 'N/A', 4)} V`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`vccbram         : ${padString(voltages.vccbram || 'N/A', 4)} V`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`vccaux          : ${padString(voltages.vccaux || 'N/A', 4)} V`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`ps_temp         : ${padString(temperatures.psTemp || 'N/A', 4)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`remote_temp     : ${padString(temperatures.remoteTemp || 'N/A', 4)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`pl_temp         : ${padString(temperatures.plTemp || 'N/A', 4)} deg C`)
    ];
}
...
function createViInfoParagraphs(results) {
    ...
    const tempData = results.temperatures || {};
    return [
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`OBC-1 3V3 D V           : ${padString(viData.d3v3?.value || 'N/A', 4)} mV`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`OBC-1 PS 3V3 OBC-2 V    : ${padString(viData.ps3v3Obc2?.value || 'N/A', 4)} mV`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`OBC-1 PS 5V OBC-2 V     : ${padString(viData.ps5vObc2?.value || 'N/A', 4)} mV`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`OBC-1 PS 5V OBC-2 I     : ${padString(viData.ps5vObc2I || 'N/A', 4)} mA`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`OBC-1 PS 3V3 OBC-2 I    : ${padString(viData.ps3v3Obc2I || 'N/A', 4)} mA`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](``),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Thruster thermistor 1   : ${padString(tempData.thruster1 || 'N/A', 3)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Thruster thermistor 2   : ${padString(tempData.thruster2 || 'N/A', 3)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`LEOCAM thermistor 1     : ${padString(tempData.leocam?.[0] || 'N/A', 3)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`LEOCAM thermistor 2     : ${padString(tempData.leocam?.[1] || 'N/A', 3)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`LEOCAM thermistor 3     : ${padString(tempData.leocam?.[2] || 'N/A', 3)} deg C`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`LEOCAM thermistor 4     : ${padString(tempData.leocam?.[3] || 'N/A', 3)} deg C`)
    ];
}
...
function createEmmcInfoParagraphs(results) {
    ...
    if (!emmcData.emmc0States || emmcData.emmc0States.length === 0 || emmcData.emmc0States[0] === 'N.A.') {
        return [
            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"]('eMMC test was not performed or data not available')
        ];
    }
    ...
    return [
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-0 : ${padString(emmc0States[0] || 'N/A', 3)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-1 : ${padString(emmc1States[0] || 'N/A', 3)}`),
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-0 : ${padString(emmc0States[1] || 'N/A', 3)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-1 : ${padString(emmc1States[1] || 'N/A', 3)}`),
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-0 : ${padString(emmc0States[2] || 'N/A', 3)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-1 : ${padString(emmc1States[2] || 'N/A', 3)}`),
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-0 : ${padString(emmc0States[3] || 'N/A', 3)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-1 : ${padString(emmc1States[3] || 'N/A', 3)}`),
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-0 : ${padString(emmc0States[4] || 'N/A', 3)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-1 : ${padString(emmc1States[4] || 'N/A', 3)}`),
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-0 : ${padString(emmc0States[5] || 'N/A', 3)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`eMMC-1 : ${padString(emmc1States[5] || 'N/A', 3)}`)
    ];
}
/**
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateOBC2WordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The OBC-2 test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateOBC2PDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateSBandWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The S-Band test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateSBandPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
...
"[project]/src/services/checkout/uhfCheckout.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function runUHFCheckout(sock, options, onProgress = ()=>{}) {
    try {
        ...
        try {
            ...
            for(let i = 0; i < 4; i++){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC2_Downlink_Type", 3);
        ...
        try {
            const telemetryResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, telemetryVars);
        ...
        try {
            const sysResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, sysVars);
        ...
        try {
            const rxResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, rxVars);
            // Process and store results
        ...
        try {
            const txResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, txVars);
            // Process and store results
...
"[project]/src/services/reports/uhfReport.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateUHFWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The UHF test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateUHFPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
    ...
    try {
        ...
        if (results.telemetry) {
            ...
            const telemetryData = [
                [
                    `Board temperature (near MCU)`,
                    `${telemetry.boardTemperature || 'N/A'} degree C`
                ],
                [
                    `PA temperature (near PA)`,
                    `${telemetry.paTemperature || 'N/A'} degree C`
                ],
                [
                    `Last received RSSI`,
                    `${telemetry.lastRssi || 'N/A'}`
                ],
                [
                    `Last received RF error`,
                    `${telemetry.lastRferr || 'N/A'}`
                ],
                [
                    `Number of tx packets since reboot`,
                    `${telemetry.txCount || 'N/A'} packets`
                ],
                [
                    `Number of rx packets since reboot`,
                    `${telemetry.rxCount || 'N/A'} packets`
                ],
                [
                    `Number of tx bytes since reboot`,
                    `${telemetry.txBytes || 'N/A'} bytes`
                ],
                [
                    `Number of rx bytes since reboot`,
                    `${telemetry.rxBytes || 'N/A'} bytes`
                ],
                [
                    `Currently active system configuration`,
                    `${telemetry.activeConf || 'N/A'}`
                ],
                [
                    `Number of reboots`,
                    `${telemetry.bootCount || 'N/A'}`
                ],
                [
                    `Cause of the reboot`,
                    `${telemetry.bootCause || 'N/A'}`
                ],
                [
                    `Timestamp of last valid packet`,
                    `${telemetry.lastContact || 'N/A'}`
                ],
                [
                    `Current background RSSI level`,
                    `${telemetry.bgndRssi || 'N/A'}`
                ],
                [
                    `Total TX duty time since reboot`,
                    `${telemetry.txDuty || 'N/A'}`
                ],
                [
                    `Number of tx packets (total)`,
                    `${telemetry.totalTxCount || 'N/A'} packets`
                ],
                [
                    `Number of rx packets (total)`,
                    `${telemetry.totalRxCount || 'N/A'} packets`
                ],
                [
                    `Number of tx bytes (total)`,
                    `${telemetry.totalTxBytes || 'N/A'} bytes`
                ],
                [
                    `Number of rx bytes (total)`,
                    `${telemetry.totalRxBytes || 'N/A'} bytes`
                ]
            ];
        ...
        if (results.system) {
            ...
            const systemData = [
                [
                    `RSSI indicator offset`,
                    `${system.rssiOffset || 'N/A'}`
                ],
                [
                    `Maximum temperature`,
                    `${system.maxTemp || 'N/A'} degree C`
                ],
                [
                    `Exponential moving average (alpha)`,
                    `${system.bgndrssiEma || 'N/A'}`
                ],
                [
                    `CSP address of the AX100 module`,
                    `${system.cspNode || 'N/A'}`
                ],
                [
                    `Enables I2C`,
                ...
                [
                    `Enables push-to-talk driver`,
                    `${system.extpptEn || 'N/A'}`
                ],
                [
                    `On-board LEDs enabled`,
                    `${system.ledEn || 'N/A'}`
                ],
                [
                    `USART for KISS interface`,
                    `${system.kissUsart || 'N/A'}`
                ],
                [
                    `USART for GOSH interface`,
                    `${system.goshUsart || 'N/A'}`
                ],
                [
                    `Non-shifted I2C address`,
                    `${system.i2cAddr || 'N/A'}`
                ],
                [
                    `I2C master speed`,
                ...
                [
                    `Seconds before automatic reboot`,
                    `${system.rebootIn || 'N/A'}`
                ],
                [
                    `Transmitter shutdown seconds`,
                    `${system.txInhibit || 'N/A'}`
                ],
                [
                    `Log-system FRAM storage enabled`,
                    `${system.logStore || 'N/A'}`
                ],
                [
                    `TX power level`,
                ...
                [
                    `Maximum TX time`,
                    `${system.maxTxTime || 'N/A'} seconds`
                ],
                [
                    `Maximum idle time`,
                    `${system.maxIdleTime || 'N/A'} seconds`
                ]
            ];
        ...
        if (results.receiver) {
            ...
            const receiverData = [
                [
                    `Frequency`,
                    `${receiver.frequency || 'N/A'} Hz`
                ],
                [
                    `Baudrate`,
                    `${receiver.baudrate || 'N/A'} bps`
                ],
                [
                    `Modulation index`,
                    `${receiver.modindex || 'N/A'}`
                ],
                [
                    `RX guard`,
                    `${receiver.guard || 'N/A'} ms`
                ],
                [
                    `PLLRANGE register startup value`,
                    `${receiver.pllrang || 'N/A'}`
                ],
                [
                    `Framing mode`,
                    `${receiver.mode || 'N/A'}`
                ...
                [
                    `CCSDS randomization enabled`,
                    `${receiver.cspRand || 'N/A'}`
                ],
                [
                    `HMAC key`,
                    `${receiver.hmacKeys?.[0] || 'N/A'}${receiver.hmacKeys?.[1] || ''}`
                ],
                [
                    `Call sign`,
                    `${receiver.ax25Call?.[0] || 'N/A'}${receiver.ax25Call?.[1] || ''}`
                ],
                [
                    `Receiver bandwidth`,
                    `${receiver.bandwidth || 'N/A'} Hz`
                ],
                [
                    `AFC pull-in range`,
                    `${receiver.afcrange || 'N/A'} Hz`
                ]
            ];
        ...
        if (results.transmitter) {
            ...
            const transmitterData = [
                [
                    `Frequency`,
                    `${transmitter.frequency || 'N/A'} Hz`
                ],
                [
                    `Baudrate`,
                    `${transmitter.baudrate || 'N/A'} bps`
                ],
                [
                    `Modulation index`,
                    `${transmitter.modindex || 'N/A'}`
                ],
                [
                    `RX guard`,
                    `${transmitter.guard || 'N/A'} ms`
                ],
                [
                    `PLLRANGE register startup value`,
                    `${transmitter.pllrang || 'N/A'}`
                ],
                [
                    `Framing mode`,
                    `${transmitter.mode || 'N/A'}`
                ],
                [
                    `HMAC enabled`,
                    `${transmitter.cspHmac || 'N/A'}`
                ],
                [
                    `Reed-Solomon enabled`,
                    `${transmitter.cspRs || 'N/A'}`
                ],
                [
                    `CRC-32 enabled`,
                    `${transmitter.cspCrc || 'N/A'}`
                ],
                [
                    `CCSDS randomization enabled`,
                    `${transmitter.cspRand || 'N/A'}`
                ],
                [
                    `HMAC key`,
                    `${transmitter.hmacKeys?.[0] || 'N/A'}${transmitter.hmacKeys?.[1] || ''}`
                ],
                [
                    `Call sign`,
                    `${transmitter.ax25Call?.[0] || 'N/A'}${transmitter.ax25Call?.[1] || ''}`
                ],
                [
                    `Preamble byte`,
                    `${transmitter.preamb || 'N/A'}`
                ],
                [
                    `Preamble length`,
                    `${transmitter.preamblen || 'N/A'} bytes`
                ],
                [
                    `Preamble flags`,
                    `${transmitter.preambflags || 'N/A'}`
                ],
                [
                    `Inter-frame byte`,
                    `${transmitter.intfrm || 'N/A'}`
                ],
                [
                    `Inter-frame length`,
                    `${transmitter.intfrmlen || 'N/A'} bytes`
                ],
                [
                    `Inter-frame flags`,
                    `${transmitter.intfrmflags || 'N/A'}`
                ],
                [
                    `RSSI busy threshold`,
                    `${transmitter.rssibusy || 'N/A'}`
                ],
                [
                    `Key-up delay`,
                    `${transmitter.kupDelay || 'N/A'}`
                ],
                [
                    `PA input level`,
                    `${transmitter.paLevel || 'N/A'}`
                ],
                [
...
async function runPropulsionCheckout(sock, options, onProgress = ()=>{}) {
    try {
        ...
        try {
            ...
            const prop1Results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, prop1TmParams);
        ...
        try {
            ...
            const prop2Results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, prop2TmParams);
            // Store telemetry values in results
            results.prop2Tm = {};
        ...
        if (options.enablePMA) {
            ...
            try {
                ...
                const propTcResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, propTcParams);
                ...
                const propStatResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, propStatParams);
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generatePropulsionWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The Propulsion test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generatePropulsionPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
    ...
    try {
        ...
        if (results.prop1Tm) {
            ...
            const keyParams = [
                {
                    key: 'ECU_Temp',
                    label: 'ECU Temperature',
                    unit: '°C'
                },
                {
                    key: 'Anode_PPU_1_Voltage',
                    label: 'Anode PPU 1 Voltage',
                    unit: 'V'
                },
                {
                    key: 'Cathode_PPU_1_Voltage',
                    label: 'Cathode PPU 1 Voltage',
                    unit: 'V'
                },
                {
                    key: 'Heater_Temp',
        ...
        if (results.prop2Tm) {
            ...
            const keyParams = [
                ...
                },
                {
                    ...
                    label: 'Anode PPU 2 Voltage',
                    unit: 'V'
                },
                {
                    key: 'Cathode_PPU_2_Voltage',
                    label: 'Cathode PPU 2 Voltage',
                    unit: 'V'
                },
                {
                    key: 'Heater_Temp',
...
async function runPCSCheckout(sock, enableSDTest, onProgress = ()=>{}) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC-1_Heps_Lcl_ExtReqOn", 14); // new parameter name and value (21 May 2025 Test)
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generatePCSWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The PCS test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generatePCSPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
...
function createMemoryTestParagraphs(results) {
    ...
    return [
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Write Success before test   : ${padString(results.sdCard.before?.writeSuccess || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Read Success before test    : ${padString(results.sdCard.before?.readSuccess || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Write Fail before test      : ${padString(results.sdCard.before?.writeFail || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Read Fail before test       : ${padString(results.sdCard.before?.readFail || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Write Success after test    : ${padString(results.sdCard.after?.writeSuccess || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Read Success after test     : ${padString(results.sdCard.after?.readSuccess || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Write Fail after test       : ${padString(results.sdCard.after?.writeFail || 'N/A', 4)}`),
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"](`Read Fail after test        : ${padString(results.sdCard.after?.readFail || 'N/A', 4)}`)
    ];
}
/**
...
async function runXBandCheckout(sock, onProgress = ()=>{}) {
    try {
        ...
        // await mccifSet(sock, "OBC1_Ch_ExtReqOn", 7);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Heps_Lcl_ExtReqOn", 14); //changed parameter name and value (21 May 2025)
        await new Promise((resolve)=>setTimeout(resolve, 2000));
        ...
        if (results.voltages.pcs.pass) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Heps_Lcl_ExtReqOn", 14);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateXBandWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The X-Band test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateXBandPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateLEOCAMWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The LEOCAM test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateLEOCAMPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
...
async function runHEPSCheckout(sock, options, onProgress = ()=>{}) {
    ...
    try {
        ...
        let mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, canVar);
        ...
        // Read CAN setting
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, canSetting);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, canVar);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, batVi);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, batT);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, saV);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, saT1);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, saT2);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, [
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, obnVi);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, bcrIt);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, pcbT);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, conv1V);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, conv2V);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, conv1T);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, conv2T);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, rlclVi);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, lclVi);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, hdrmVi);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
        ...
        mccResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
        ...
        if (options.testHeaters) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_ExtReqOn", 18);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            // Enable Heater 1
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOn", 1);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            // Disable Heater 1
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOff", 1);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading3 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            // Enable Heater 2
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOn", 2);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading4 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            // Disable Heater 2
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOff", 2);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading5 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            // Enable Heater 3
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOn", 3);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading6 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            // Disable Heater 3
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOff", 3);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading7 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_ExtReqOff", 18);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater1TestReading8 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater1Vi);
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_ExtReqOn", 19);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            // Enable Heater 4
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOn", 4);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            // Disable Heater 4
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOff", 4);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading3 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            // Enable Heater 5
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOn", 5);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading4 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            // Disable Heater 5
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOff", 5);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading5 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            // Enable Heater 6
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOn", 6);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading6 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            // Disable Heater 6
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_HeaterSwReqOff", 6);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading7 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Ch_ExtReqOff", 19);
            await new Promise((resolve)=>setTimeout(resolve, 2000));
            let heater2TestReading8 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifRead"])(sock, heater2Vi);
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateHEPSWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The HEPS test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateHEPSPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
...
async function runADCSCheckout(sock, options, onProgress = ()=>{}) {
    try {
        ...
        const adcsVi = [
            "HEPS1_PDM2_ADCS_IF_V",
            "HEPS1_PDM2_ADCS-IF_I",
            "HEPS1_PDM2_ADCS_RW_V",
            "HEPS1_PDM2_ADCS_RW_I"
        ];
        const adcsTlm128 = [
            "ADCS1_TLM_Identifier",
            "ADCS1_TLM_InterfaceVer",
            "ADCS1_TLM_IdFwVerMajor",
            "ADCS1_TLM_IdFwVerMinor",
            "ADCS1_TLM_RuntimeSec",
            "ADCS1_TLM_RuntimeMiliSec"
        ];
        const adcsStat = [
            "OBC1_Itc_Adcs_Tm_TxCount",
            "OBC1_Itc_Adcs_Tm_AckCount",
            "OBC1_Itc_Adcs_Tm_TimeoutCount",
            "OBC1_Itc_Adcs_Tm_ErrCount"
        ];
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateADCSWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The ADCS test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateADCSPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
...
async function runGPSCheckout(sock, onProgress = ()=>{}) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$mccUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mccifSet"])(sock, "OBC1_Gps_Control", 3); // value =4 for 'Power Off' (21 May 2025 Test)
        await new Promise((resolve)=>setTimeout(resolve, 2000));
 ...
 * @returns A promise that resolves to the filename of the saved report
 */ async function generateGPSWordReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
 ...
 * @param results The GPS test results
 * @returns A promise that resolves to the filename of the saved PDF report
 */ async function generateGPSPDFReport(results) {
    // Get current date and time for the report filename
    const now = new Date();
    const dateStr = now.toISOString().split('T')[0]; // YYYY-MM-DD
    const timeStr = now.toTimeString().split(' ')[0].replace(/:/g, '-'); // HH-MM-SS
...
//# sourceMappingURL=src_services_f2d3820d._.js.map